...
and stores app data on the user's device.
...
All Of Me does not currently provide server sync or account recovery. If app data
is deleted from the device and no backup exists, support may not be able to
restore it.
